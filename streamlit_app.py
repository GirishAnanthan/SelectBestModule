...
div[data-baseweb="select"] > div {{ background: #000000 !important; border: 1px solid {t['border']} !important; border-radius: 6px !important; color: #ffffff !important; font-family: 'Manrope',sans-serif !important; font-size: 0.8rem !important; min-height: 2.2rem !important; }}
...
div[data-baseweb="popover"], div[role="listbox"], div[role="option"] {{ background: #000000 !important; color: #ffffff !important; }}
...
st.markdown(f"""
<div class="section-heading" style="padding: 1rem 1.5rem; background: {t['bg']}; border-bottom: 1px solid {t['border']}; margin-bottom: 1rem; display: flex; justify-content: space-between; align-items: center;">
    <div style="display: flex; align-items: baseline; gap: 0.8rem; flex-wrap: wrap;">
        ...
        <p style="margin: 0; opacity: 0.7; font-size: 0.8rem; color: {t['text']};">({tr_html(STEP_DESCS[step])})</p>
    </div>
    <div style="font-family: 'DM Mono', monospace; font-size: 0.7rem; color: {t['muted']};">{step+1} / 6</div>
</div>
""", unsafe_allow_html=True)
